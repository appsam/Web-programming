        ...
        <aside class="side-bar">
            ...
            <ul>
                ...
                <li>
                    <a href="#">나만의 레시피</a>
                    <ul>
                        <li><a href="#" onclick="showImages('나만의 레시피', '한식')">한식</a></li>
                        <li><a href="#" onclick="showImages('나만의 레시피', '중식')">중식</a></li>
                        <li><a href="#" onclick="showImages('나만의 레시피', '양식')">양식</a></li>
                        <li><a href="#" onclick="showImages('나만의 레시피', '일식')">일식</a></li>
                    </ul>
                </li>
                <li>
                    <a href="#">남의 레시피</a>
                    <ul>
                        <li><a href="#" onclick="showImages('남의 레시피', '한식')">한식</a></li>
                        <li><a href="#" onclick="showImages('남의 레시피', '중식')">중식</a></li>
                        <li><a href="#" onclick="showImages('남의 레시피', '양식')">양식</a></li>
                        <li><a href="#" onclick="showImages('남의 레시피', '일식')">일식</a></li>
                    </ul>
                </li>
            </ul>
        </aside>
